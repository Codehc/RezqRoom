...
sonarState detectionHistory[3] = {NONE_DETECTED, NONE_DETECTED, NONE_DETECTED};
...
void enabledPeriodic()
{
    ...
    else
    {
        ...
        Serial.print(sonarHistory[0]);
        Serial.print(" ");
        Serial.print(sonarHistory[1]);
        Serial.print(" ");
        Serial.print(sonarHistory[2]);
        Serial.print(" ");
        Serial.println(sonarHistory[3]);
...
void addToDetectionHistory(sonarState state)
{
    ...
    detectionHistory[2] = state;
}

sonarState getDetected()
{
    if (detectionHistory[0] == detectionHistory[1] && detectionHistory[0] == detectionHistory[2])
    {
